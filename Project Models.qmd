...
```{r}
num.only_data <- na.omit(model_data[,c(11,13,16,19,20,21,28,29)]) ### Need to get rid of any rows with na's, removed 1607 rows for upcoming PCA analysis. ##race_whiteE, race_native_american_E, race_other_E,age_medianE,median_household_incomeE, median_monthly_housing_costsE, ints.per.acre, transit.stops.per.acre
...
sample.data <- num.only_data[samp.vct,]
